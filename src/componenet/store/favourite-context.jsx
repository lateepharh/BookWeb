...
export function FaavouriteContextProvider(props){
    ...
    function addFavourite(favouritebook){
        setFavourite((previousFavourite)=>{
            return(
                previousFavourite.concat(favouritebook)
            );
        });
    };
    ...
    return(
        <Favourite_context.Provider value={contextValue}>{props.children}</Favourite_context.Provider>
    )
}
